...
export class ContadoresRetencionesComponent implements OnInit {
  public fecha: string = '';
    ...
    var axu = 0; 
      ...
      if (this.getRuc(this.selected) != 'do') {
        if (this.fecha_actual != 'null' && this.fecha_final != 'null') {
          ...
          this.consultaService.consultaContadoresRetenciones( this.getRuc(this.selected), this.fecha_actual, this.fecha_final).subscribe(data => {
